...
int main(){
  ...
  pthread_create(&t2, 0, svp_simple_030_001_isr_1, 0);
  pthread_create(&t3, 0, svp_simple_030_001_isr_1, 0);
  pthread_create(&t4, 0, svp_simple_030_001_isr_2, 0);
  pthread_create(&t5, 0, svp_simple_030_001_isr_2, 0);
  pthread_create(&t6, 0, svp_simple_030_001_isr_2, 0);
  pthread_create(&t7, 0, svp_simple_030_001_isr_3, 0);
  pthread_create(&t8, 0, svp_simple_030_001_isr_3, 0);
  pthread_create(&t9, 0, svp_simple_030_001_isr_3, 0);
}
