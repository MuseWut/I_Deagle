...
// 2: svp_simple_022_001_global_var1 <R, #55>, <W,#66>, <R,#58> // rww
// 3: svp_simple_022_001_global_var1 <R, #58>, <W,#66>, <R,#63> // wwr
...
int main(){
  ...
  pthread_create(&t2, 0, svp_simple_022_001_isr_1, 0);
  pthread_create(&t3, 0, svp_simple_022_001_isr_1, 0);
}
